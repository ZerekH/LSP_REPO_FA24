...
public class IntegerSet  {
	...
	*/
	...
	public int largest()  {
		if (set.isEmpty()) {
			throw new IllegalStateException("Set is empty. Cannot determine the largest element.");
		}
	...
	public int smallest()  {
		if (set.isEmpty()) {
			throw new IllegalStateException("Set is empty. Cannot determine the smallest element.");
		}
